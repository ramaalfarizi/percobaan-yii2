...
class CustomerController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $isHaveCustomer = Customer::find()->where(['user_id' => $loggedUserId])->count();

        if ($this->request->isPost) {
            if ($isHaveCustomer) Yii::$app->session->setFlash('error', 'sudah memiliki user!');
            else {
                $model->user_id = $loggedUserId;
